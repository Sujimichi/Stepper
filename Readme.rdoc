...
You could run that test again with the <pre>--format usage</pre> option but a) you have to wait for that test to run and b) you will get a load of un-needed information about all the other steps.
